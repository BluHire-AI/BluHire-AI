      ...
      <div className="flex h-screen bg-zinc-50 dark:bg-[#070b13] transition-colors duration-300">
              ...
              {navigation.map((item) => {
                ...
                return (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className={`relative flex items-center px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all group duration-300 ${
                        isActive
                    ...
                    >
                      ...
                      <Icon className={`w-5 h-5 mr-3.5 transition-transform duration-300 group-hover:scale-105 ${
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <header className="h-16 bg-white dark:bg-[#0e1422] border-b border-zinc-200/80 dark:border-zinc-800/80 flex items-center justify-between px-8 z-10 shadow-sm transition-colors duration-300">
            <div>
              <h2 className="text-lg font-semibold text-zinc-800 dark:text-zinc-100 flex items-center">
