...
export default function PipelineBoard() {
  ...
  return (
    <div className="space-y-6 font-sans text-zinc-100 bg-[#050811] min-h-screen pb-12 p-1">
      {/* Navigation Headers */}
      <div className="flex flex-wrap items-center justify-between border-b border-zinc-800/80 pb-4 gap-4">
        <div className="flex items-center gap-1.5 bg-[#0e1422] p-1 rounded-xl border border-zinc-800/50">
          <Link href="/dashboard/recruitment">
            <span className="text-xs font-bold px-4 py-2 rounded-lg text-zinc-400 hover:text-zinc-100 cursor-pointer block transition-colors">
              Overview
            </span>
          </Link>
          ...
          <Link href="/dashboard/recruitment/pipeline">
            <span className="text-xs font-bold px-4 py-2 rounded-lg bg-[#161f30] text-blue-400 shadow-sm cursor-pointer block">
              ATS Pipeline Grid
            </span>
          </Link>
        ...
        <div>
          <Link href="/careers" target="_blank">
            <Button variant="outline" size="sm" className="text-xs flex items-center gap-1.5 rounded-xl border-zinc-800 hover:bg-zinc-900 bg-transparent text-zinc-350">
              Careers Portal
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
        <div className="bg-[#0e1422] border border-zinc-800/80 rounded-xl p-3.5 shadow-sm text-left relative overflow-hidden group">
          <div className="absolute top-0 left-0 w-1 h-full bg-blue-500" />
          <p className="text-[10px] text-zinc-500 font-extrabold uppercase tracking-wider">Total Applications</p>
          <h3 className="text-xl font-black mt-1 text-zinc-250 group-hover:scale-105 transition-transform duration-300 origin-left">
        ...
        <div className="bg-[#0e1422] border border-zinc-800/80 rounded-xl p-3.5 shadow-sm text-left relative overflow-hidden group">
          ...
          <p className="text-[10px] text-zinc-500 font-extrabold uppercase tracking-wider">Offers Sent</p>
          <h3 className="text-xl font-black mt-1 text-sky-400 group-hover:scale-105 transition-transform duration-300 origin-left">
            {stats?.pipelineStats?.OFFER || 0}
          </h3>
        </div>
        <div className="bg-[#0e1422] border border-zinc-800/80 rounded-xl p-3.5 shadow-sm text-left relative overflow-hidden group">
      ...
      {stageStats.length > 0 && (
        <Card className="bg-[#0e1422] border-zinc-850 p-4 rounded-xl">
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-between gap-3 text-xs">
            {stageStats.map((item, idx) => (
              <React.Fragment key={item.name}>
                <div className="flex-1 bg-zinc-950/45 p-2.5 rounded-xl border border-zinc-850 flex flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="font-extrabold text-[9px] uppercase tracking-wider text-zinc-400">{item.name}</span>
                  ...
                  <div className="mt-3 flex items-end justify-between">
                    <div>
                      ...
                      <span className="text-xs font-black text-zinc-200 mt-0.5 block">{item.conversionRate}%</span>
                    </div>
                    <div>
                      <span className="text-[8px] text-zinc-500 font-bold block uppercase">Total Share</span>
                      <span className="text-xs font-black text-zinc-400 mt-0.5 block">{item.percentage}%</span>
                    </div>
                  </div>
                </div>
      ...
      {/* Filters Toolbar Row */}
      <div className="bg-[#0e1422] p-4 rounded-xl border border-zinc-850 space-y-3 shadow-md">
        <div className="flex items-center justify-between">
          <h4 className="text-[10px] font-extrabold tracking-wider uppercase text-zinc-500">Recruiter Filters Panel</h4>
          <Button onClick={handleResetFilters} variant="ghost" size="sm" className="text-xs h-7 text-zinc-400 hover:text-zinc-100 font-bold flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 text-xs bg-zinc-950/60 border-zinc-800 text-zinc-200 placeholder:text-zinc-500 h-9 rounded-lg"
            />
          </div>

          {/* Skill Search */}
          <div className="relative">
            <Award className="absolute left-2.5 top-2.5 w-3.5 h-3.5 text-zinc-550" />
            <Input
          ...
          <select
            ...
            className="bg-zinc-950/60 border border-zinc-800 text-xs font-semibold px-2.5 py-1.5 rounded-lg text-zinc-350 focus:outline-none focus:border-blue-500 h-9 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-1 min-w-[170px]">
            <input
              ...
              className="bg-zinc-950/60 border border-zinc-800 text-[9px] font-semibold p-1 rounded-lg text-zinc-350 focus:outline-none h-9 w-full cursor-pointer"
              title="Applied From"
            />
      ...
      <Card className="bg-[#0e1422] border-zinc-850 rounded-xl overflow-hidden shadow-md">
        <div className="p-4 border-b border-zinc-850/80 flex items-center justify-between bg-zinc-950/15">
                ...
                applications.map((app) => {
                  ...
                  return (
                    <TableRow
                      ...
                      className={`cursor-pointer hover:bg-zinc-950/20 border-zinc-850 transition-colors ${
                    ...
                    >
                      ...
                      <TableCell className="pl-2">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center font-bold text-xs text-white uppercase shadow-sm shrink-0">
                            {cand.firstName[0]}
                            {cand.lastName[0]}
                          </div>
                          <div className="min-w-0">
                            <h4 className="text-xs font-black text-zinc-200 hover:text-blue-400 truncate">
                      ...
                      <TableCell>
                        <div className="min-w-[120px] max-w-[200px]">
                          <p className="text-xs font-bold text-zinc-350 truncate">{job.title}</p>
                          <p className="text-[9px] text-zinc-550 font-bold tracking-wide mt-0.5 truncate uppercase">
                      ...
                      <TableCell className="text-right pr-6" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1.5">
                          <Button
                            ...
                            size="icon"
                            variant="ghost"
                            className="w-7 h-7 rounded hover:bg-zinc-800/80 text-zinc-450 hover:text-zinc-200"
                          ...
                          <Button
                            ...
                            size="icon"
                            variant="ghost"
                            className="w-7 h-7 rounded hover:bg-emerald-950/20 text-emerald-500"
        ...
        <div className="p-4 bg-zinc-950/25 border-t border-zinc-850 flex flex-wrap items-center justify-between gap-4 text-xs font-semibold text-zinc-450">
      ...
      {drawerOpen && selectedApp && (
        <>
          ...
          {/* Drawer Right Body */}
          <div className="fixed top-0 right-0 h-full w-[480px] sm:w-[560px] md:w-[680px] bg-[#0c101b] border-l border-zinc-850 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col">
            {/* Drawer Header */}
            <div className="p-5 border-b border-zinc-850/80 bg-zinc-950/30 flex items-start justify-between">
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <span className={`text-[8px] font-black px-2 py-0.5 rounded-full tracking-wider uppercase ${getStageBadgeColor(selectedApp.currentStage)}`}>
                ...
                <h3 className="text-base font-black text-zinc-100 mt-1.5 flex items-center gap-2">
              ...
              <Button
                ...
                size="icon"
                variant="ghost"
                className="w-8 h-8 rounded-lg hover:bg-zinc-900 text-zinc-450 hover:text-zinc-200"
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
            ...
            {selectedApp.currentStage !== 'HIRED' && selectedApp.currentStage !== 'REJECTED' && (
              <div className="px-5 py-3 bg-zinc-950/20 border-b border-zinc-850 flex items-center justify-between gap-4">
                <div className="flex items-center gap-1">
                  ...
                  <select
                    ...
                    className="bg-[#161f30] text-[10px] font-black px-2 py-1 rounded border border-zinc-800 text-zinc-350 focus:outline-none cursor-pointer"
                  >
                    {ACTIVE_STAGES.map((s) => (
                      <option key={s} value={s}>{s}</option>
                    ))}
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="h-8 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-[10px] flex items-center gap-1 rounded-lg"
                  >
            ...
            <div className="flex border-b border-zinc-850/80 px-4 bg-zinc-950/10 text-xs font-bold gap-1 py-1.5 overflow-x-auto shrink-0 scrollbar-none">
              {[
            ...
            <div className="flex-1 overflow-y-auto p-5 text-xs">
              ...
              {drawerTab === 'profile' && (
                <div className="space-y-5">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-zinc-950/25 p-4 rounded-xl border border-zinc-850">
                      <div>
                      ...
                      <div>
                        ...
                        {selectedApp.candidateId?.linkedinUrl ? (
                          <a href={selectedApp.candidateId.linkedinUrl} target="_blank" rel="noopener noreferrer" className="font-bold text-blue-400 hover:underline flex items-center gap-1 mt-1">
                            <LinkIcon className="w-3 h-3 text-zinc-500" />
                            linkedin.com/profile
                          </a>
                        ) : (
                          <p className="font-bold text-zinc-600 mt-1">N/A</p>
                        )}
                      </div>
                      <div>
                        <p className="text-[9px] text-zinc-500 font-extrabold uppercase">Portfolio / GitHub</p>
                        {selectedApp.candidateId?.portfolioUrl ? (
                          <a href={selectedApp.candidateId.portfolioUrl} target="_blank" rel="noopener noreferrer" className="font-bold text-blue-400 hover:underline flex items-center gap-1 mt-1">
                            <LinkIcon className="w-3 h-3 text-zinc-500" />
                            sourcing portfolio
                          </a>
                        ) : (
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-zinc-950/25 p-4 rounded-xl border border-zinc-850">
                      <div>
                        ...
                        <p className="font-bold text-zinc-300 mt-1">{selectedApp.candidateId?.currentCompany || 'N/A'}</p>
                      </div>
                      <div>
                        <p className="text-[9px] text-zinc-500 font-extrabold uppercase">Current Designation</p>
                        <p className="font-bold text-zinc-300 mt-1">{selectedApp.candidateId?.currentDesignation || 'N/A'}</p>
                      </div>
                      <div>
                        <p className="text-[9px] text-zinc-500 font-extrabold uppercase">Expected Compensation</p>
                        <p className="font-bold text-zinc-300 mt-1">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-zinc-300 mt-1">{selectedApp.candidateId?.noticePeriod || 'Immediate'}</p>
                      </div>
                      <div>
                        <p className="text-[9px] text-zinc-500 font-extrabold uppercase">Sourcing Source</p>
                        <span className="font-bold text-zinc-350 bg-zinc-900 border border-zinc-850 px-2 py-0.5 rounded mt-1 inline-block uppercase text-[10px]">
                ...
                <div className="space-y-4 h-full flex flex-col">
                  ...
                  {selectedApp.candidateId?.resume?.fileName ? (
                    <div className="flex-1 flex flex-col space-y-4">
                      <div className="border border-zinc-850 rounded-xl p-4 flex items-center justify-between bg-zinc-950/25">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <p className="font-bold text-zinc-200 truncate max-w-[280px]">{selectedApp.candidateId.resume.fileName}</p>
                            <p className="text-[9px] text-zinc-550 mt-0.5">Uploaded: {formatDate(selectedApp.candidateId.resume.uploadedAt)}</p>
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <Button
                      ...
                      <div className="flex-1 min-h-[340px] border border-zinc-850 rounded-xl overflow-hidden bg-zinc-950/50 relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 text-zinc-500 space-y-2 pointer-events-none">
                          ...
                          <p className="font-bold text-xs text-zinc-400">PDF Document Stream Preview Container</p>
                    ...
                    <div className="text-center py-16 text-zinc-500 border-2 border-dashed border-zinc-850 rounded-xl bg-zinc-950/10">
                      <FileText className="w-10 h-10 text-zinc-700 mx-auto mb-2" />
                      <p className="font-bold text-zinc-400">No Resume document available</p>
              ...
              {drawerTab === 'skills' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {selectedApp.candidateId?.skills?.map((s) => (
                        <span key={s} className="text-[10px] font-bold px-2.5 py-1 rounded bg-[#161f30] text-zinc-300 border border-zinc-800 shadow-sm">
                          {s}
                        </span>
                  ...
                  <div className="bg-zinc-950/20 p-4 rounded-xl border border-zinc-850 space-y-4">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {selectedApp.matchingSkills && selectedApp.matchingSkills.length > 0 ? (
                          selectedApp.matchingSkills.map((s) => (
                            <span key={s} className="text-[9px] font-bold px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">{s}</span>
                          ))
                        ) : (
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {selectedApp.missingSkills && selectedApp.missingSkills.length > 0 ? (
                          selectedApp.missingSkills.map((s) => (
                            <span key={s} className="text-[9px] font-bold px-2 py-0.5 rounded bg-rose-500/10 text-rose-400 border border-rose-500/20">{s}</span>
                          ))
                        ) : (
              ...
              {drawerTab === 'interviews' && (
                <div className="space-y-4">
                  ...
                  <div className="bg-zinc-950/25 p-4 rounded-xl border border-zinc-850 space-y-3">
                    <div className="flex items-center justify-between pb-2 border-b border-zinc-850/80">
                      <div>
                        <span className="text-[8px] text-zinc-550 font-bold uppercase block">Technical Assessment Status</span>
                        <span className="text-xs font-bold text-zinc-350 mt-0.5 block">{selectedApp.interviewStatus || 'Scheduled'}</span>
                      </div>
                      {selectedApp.interviewScore !== undefined && selectedApp.interviewScore !== null && (
                        <div className="text-right">
                          <span className="text-[8px] text-zinc-550 font-bold uppercase block">Score</span>
              ...
              {drawerTab === 'evaluation' && (
                <div className="space-y-5">
                  ...
                  <div className="space-y-4 bg-zinc-950/25 p-4 rounded-xl border border-zinc-850">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg w-full text-xs"
                    >
                  ...
                  <div className="space-y-3 pl-2 max-h-[380px] overflow-y-auto">
                    {selectedApp.stageHistory.map((hist, idx) => (
                      <div key={idx} className="text-[10px] leading-relaxed relative pb-2 border-l border-zinc-800 pl-4 last:border-l-0">
                        ...
                        <p className="font-black text-zinc-350 uppercase">{hist.stage}</p>
            ...
            <div className="p-4 border-t border-zinc-850 bg-zinc-950/20 flex items-center justify-end shrink-0">
              <Button onClick={() => setDrawerOpen(false)} variant="outline" className="text-xs rounded-xl border-zinc-800 bg-transparent text-zinc-350 hover:bg-zinc-900">
                Close Profile
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
            ...
            <div className="flex items-center gap-1">
              <select
                ...
                className="bg-zinc-950 border border-zinc-800 text-[10px] font-black px-2 py-1 rounded focus:outline-none cursor-pointer text-zinc-350 h-8"
              >
              ...
              <Button
                ...
                size="sm"
                className="bg-blue-600 hover:bg-blue-700 disabled:opacity-40 text-white font-bold text-[10px] h-8 rounded-lg"
              >
                Apply
              </Button>
            </div>
            ...
            {/* Mock Assign Recruiter */}
            <Button
              onClick={handleBulkAssign}
              size="sm"
              variant="outline"
              className="text-[10px] border-zinc-800 text-zinc-400 hover:bg-zinc-900 rounded-lg h-8 px-2"
            ...
            <Button
              ...
              variant="ghost"
              size="sm"
              className="h-8 w-8 p-0 rounded-lg hover:bg-zinc-900 text-zinc-450 hover:text-zinc-200"
            >
