...
// Add skill
router.post('/:id/skills', (0, rbac_middleware_1.requireEmployeeAccess)(), (0, validate_middleware_1.validateBody)(employee_validator_1.addSkillSchema), employee_controller_1.default.addSkill.bind(employee_controller_1.default));
// Remove skill
router.delete('/:id/skills/:skillName', (0, rbac_middleware_1.requireEmployeeAccess)(), employee_controller_1.default.removeSkill.bind(employee_controller_1.default));
// Add education
router.post('/:id/education', (0, rbac_middleware_1.requireEmployeeAccess)(), (0, validate_middleware_1.validateBody)(employee_validator_1.addEducationSchema), employee_controller_1.default.addEducation.bind(employee_controller_1.default));
// Add certification
router.post('/:id/certifications', (0, rbac_middleware_1.requireEmployeeAccess)(), (0, validate_middleware_1.validateBody)(employee_validator_1.addCertificationSchema), employee_controller_1.default.addCertification.bind(employee_controller_1.default));
// Upload document
router.post('/:id/documents', (0, rbac_middleware_1.requireEmployeeAccess)(), (0, validate_middleware_1.validateBody)(employee_validator_1.uploadDocumentSchema), employee_controller_1.default.uploadDocument.bind(employee_controller_1.default));
