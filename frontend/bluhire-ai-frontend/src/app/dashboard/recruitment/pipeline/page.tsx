...
import { CandidateDrawer, DrawerTabKey } from '@/components/recruitment/candidate-drawer';
...
export default function PipelineBoard() {
  ...
  const [drawerTab, setDrawerTab] = useState<DrawerTabKey>('profile');
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <CandidateDrawer
        ...
        onStageChange={(appId, newStage) =>
          handleStageChange(appId, newStage, 'Moved via drawer stage selectors')
        }
